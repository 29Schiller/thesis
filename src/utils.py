...
local_paths = dict(
    darwin=dict(
        img_dir='./datasets/Lung-Segmentation/Darwin/img', 
        mask_dir='./datasets/Lung-Segmentation/Darwin/mask'
    ),
    shenzen=dict(
        img_dir='./datasets/Lung-Segmentation/Shenzhen/img', 
        mask_dir='./datasets/Lung-Segmentation/Shenzhen/mask'
    ),
    montgomery=dict(
        img_dir='./datasets/Lung-Segmentation/Montgomery/images', 
        mask_dir='./datasets/Lung-Segmentation/Montgomery/masks'
    ),
)
